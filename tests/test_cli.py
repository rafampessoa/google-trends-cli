...
class TestCLI:
    ...
    def test_suggest_topics_command(self, mock_suggester_class, mock_client_class, 
                                   cli_runner, mock_content_suggester):
    ...
    @patch('gtrends.cli.TrendsClient')
    @patch('gtrends.cli.ContentSuggester')
    def test_writing_opportunities_command(self, mock_suggester_class, mock_client_class, 
                                         cli_runner, mock_content_suggester):
