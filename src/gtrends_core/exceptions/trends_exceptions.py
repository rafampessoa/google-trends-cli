...
class TrendsException(Exception):
    ...
    def __init__(self, message: str, error_code: str = "TRENDS_ERROR", context: Optional[Dict[str, Any]] = None):
...
class NoDataException(TrendsException):
    ...
    def __init__(self, message: str = "No data available for this request", context: Optional[Dict[str, Any]] = None):
...
class RateLimitException(TrendsException):
    ...
    def __init__(self, message: str = "Rate limit exceeded", retry_after: Optional[int] = None, context: Optional[Dict[str, Any]] = None):
        ctx = {}
...
class ExportException(TrendsException):
    ...
    def __init__(self, message: str, file_path: str, format: str, context: Optional[Dict[str, Any]] = None):
