...
from gtrends_api.schemas.responses import TopicSuggestionsResponse, TopicSuggestionItem
from gtrends_core.services.suggestion_service import SuggestionService
from gtrends_core.utils.validators import validate_region_code, validate_category, parse_timeframe
...
async def get_topic_suggestions(
    ...
    timeframe: str = Query("today 7-d", description="Timeframe for data (e.g., 'today 7-d', 'today 1-m')"),
    ...
    This endpoint suggests topics for content creation based on trending searches and category relevance.
