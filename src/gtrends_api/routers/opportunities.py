...
async def get_writing_opportunities(
    ...
    timeframe: str = Query("today 1-m", description="Timeframe for data (e.g., 'today 1-m', 'now 7-d')"),
    seed_topics: Optional[List[str]] = Query(None, description="Seed topics to base opportunities on (optional)"),
