...
from gtrends_api.schemas.responses import GrowthResponse, GrowthItem
...
async def get_topic_growth(
    ...
    Returns growth data for each topic, including start/end values, growth percentage, and trend categorization.
    """
