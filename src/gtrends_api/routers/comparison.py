...
@router.get("/", response_model=InterestOverTimeResponse, summary="Compare interest over time between topics")
async def get_comparison(
    ...
    timeframe: str = Query("today 3-m", description="Timeframe for data (e.g., 'today 3-m', 'today 12-m')"),
...
@router.post("/", response_model=InterestOverTimeResponse, summary="Compare interest over time between topics")
